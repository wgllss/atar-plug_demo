...
//        CommonToast2.toastBackgroundId = toastBackgroundId;
//        CommonToast2.toastTextColorId = toastTextColorId;
//    }
//
//    /**
//     * 显示toast
...
//     * @description:
//     */
//    public static void show(Context context, String strContent) {
//        show(context, strContent, 0, 0, Gravity.CENTER, 0, 3000, false);
//    }
//
//    public static void show(Context context, String strContent, int dealyMills) {
//        show(context, strContent, 0, 0, Gravity.CENTER, 300, dealyMills, false);
//    }
//
//    public static void show(Context context, String strContent, int gravity, int offy) {
//        show(context, strContent, 0, 0, Gravity.CENTER, offy, 3000, false);
//    }
//
...
//     * @description:
//     */
//    public static void show(Context context, String strContent, int widthRate, int heightRate, int gravity, long delayMillis) {
//        show(context, strContent, widthRate, heightRate, gravity, 300, delayMillis, false);
//    }
//
//    /**
//     * 在时间间隔内不作提示
...
//     * @description:
//     */
//    public static void showWhihPeriod(Context context, String strContent) {
//        show(context, strContent, 0, 0, Gravity.CENTER, 0, 2000, isInToastPeriod());
//    }
//
////    /**
////     * 检测toast权限是否打开
