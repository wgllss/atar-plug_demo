...
public class HttpUrlConnectionRequest {
    ...
    public static String getResult(String httpurl, Map<String, String> parames, String inputEncoding, Activity activity) {
        ...
        try {
            ...
            if (parames != null) {
                ...
                ZzLog.i("HttpUrlConnectionGet-->请求URL------>:" + httpurl);
            }
            ...
            if (statusCode == 200) {
                ...
                ZzLog.i("HttpUrlConnectionGet---url----->" + httpurl + "---接口" + statusCode);
            }
            br.close();
            isr.close();
            conn.disconnect();
    ...
    public static String postData(String httpurl, Map<String, String> parames, String body, String inputEncoding, Activity activity) {
        SoftReference<Activity> mSoftReference = null;
        if (activity != null) {
            mSoftReference = new SoftReference<Activity>(activity);
        }
        ...
        try {
            ...
            for (Map.Entry entry : parames.entrySet()) {
                httpurl += (String) entry.getKey() + "=" + entry.getValue() + "&";
            }
            ZzLog.i("HttpUrlConnectionPost----url----->" + httpurl + "---");
            ...
            if (statusCode == 200) {
                ...
                ZzLog.i("HttpUrlConnectionPost----url----->" + httpurl + "---接口" + statusCode);
            }
            if (dos != null) {
                dos.close();
            }
    ...
    public static String postData(String httpurl, Map<String, String> parames, String body, String inputEncoding) {
        return postData(httpurl, parames, body, inputEncoding, null);
    }
