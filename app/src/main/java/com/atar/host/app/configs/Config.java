...
public class Config {
    ...
    //下载配置文件 地址
    public static String config_file_url = host + ":8080/assets/config/android_app_config_json.txt";
    //下载皮肤地址
    public static final String download_skin_url = host + "assets/html/download_skin.apk";
